...
#define BOOST_TEST_MODULE FuturoCoin Test Suite

#include "test_futurocoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_futurocoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
