...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("FuturoCoin Core futurocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  futurocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded futurocoin transaction") + "\n" +
              "  futurocoin-tx [options] -create [commands]   " + _("Create hex-encoded futurocoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded futurocoin transaction
