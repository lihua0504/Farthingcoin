...
Only requiring some minor changes is futurocoin.cpp.
...
Changes to futurocoin.cpp
----------------------
futurocoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
