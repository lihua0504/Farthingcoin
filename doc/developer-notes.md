...
FuturoCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9008 for connections and services them.
...
However, in open source software such as FuturoCoin Core, where everyone uses
...
pay attention to for reviewers of FuturoCoin Core code.

General FuturoCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: FuturoCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
